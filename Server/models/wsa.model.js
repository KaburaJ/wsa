...
module.exports = function(sequelize) {
  ...
  const ConnectedDeviceSodiumHypochlorite = sequelize.define("ConnectedDeviceSodiumHypochlorite", {
    Id: {
      type: DataTypes.INTEGER,
      allowNull: false,
      autoIncrement: true,
    ...
    SodiumHypochloriteActualValue: { type: DataTypes.FLOAT, allowNull: false },
    SodiumHypochloriteTargetValue: { type: DataTypes.FLOAT, allowNull: false },
